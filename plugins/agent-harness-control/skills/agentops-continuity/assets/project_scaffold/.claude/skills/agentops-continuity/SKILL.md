...
description: Maintain local agent memory, task state, compaction recovery, stop gates, and verification continuity for long Claude Code or Codex repository sessions. Use when a task spans many tool calls, compaction, handoff, CI/debug loops, or multiple skills.
---
