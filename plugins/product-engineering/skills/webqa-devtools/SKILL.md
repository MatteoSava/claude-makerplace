---
name: webqa-devtools
description: Use when browser-based QA or debugging is needed for web apps with Chrome DevTools MCP, frontend verification, UI smoke tests, console/network debugging, accessibility checks, responsive checks, performance traces, or browser evidence after web/UI changes.
---
